...
val test = { c: Collection<Int> -> c.forEach { i: Int -> (i.rem(2) == 0) } }

val test = { c: Collection<Int> -> c. { i: Int -> (i.rem(2) == 0) } }

fun task4(collection: Collection<Int>): Boolean = test(collection)